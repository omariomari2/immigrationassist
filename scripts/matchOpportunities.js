...
const EMPLOYER_DATA_PATH = path.join(__dirname, '../data/employerData.json');
const OPPORTUNITIES_PATH = path.join(__dirname, '../data/opportunities.json');
const PUBLIC_OUTPUT_PATH = path.join(__dirname, '../public/employerData.json');
...
fs.writeFileSync(PUBLIC_OUTPUT_PATH, JSON.stringify(employerData));
