...
export const NavIcons: React.FC<NavIconsProps> = ({ activeMegaTab, activeTab, onMegaTabChange, onUserClick }) => {
    return (
        <div className="flex items-center gap-1.5 bg-white p-1 rounded-xl shadow-sm border border-gray-100/50">
            <NavIconWrapper
                active={activeMegaTab === MegaTab.Dashboard && activeTab !== TabOption.Users}
                onClick={() => onMegaTabChange(MegaTab.Dashboard)}
                title="Dashboard"
            >
                <IconPie />
            </NavIconWrapper>
            ...
            <NavIconWrapper
                active={activeMegaTab === MegaTab.SourceOfTruth}
                onClick={() => onMegaTabChange(MegaTab.SourceOfTruth)}
            ...
            <NavIconWrapper
                active={activeMegaTab === MegaTab.Resources}
                onClick={() => onMegaTabChange(MegaTab.Resources)}
                title="Resources"
            >
                <IconFile />
            </NavIconWrapper>
